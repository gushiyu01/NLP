            ...
            try:
                ...
                body = {
                    ...
                    '_source': {
                        ...
                        'atUserScreenNameList': ','.join(tt.get('tw_lat_sname')),
                        'content': tt.get('cont'),
                        'spec': tt.get('_spec'),
                        'likeNum': tt.get('nlike'),
                        'rootLikeNum': tt.get('tw_r_nlike'),
                        'messageType': tt.get('tw_msg_type'),
                        ...
                        'location': tt.get('loc'),
                        'hashTagList': tt.get('tw_lhashtag')
                    }
                }
